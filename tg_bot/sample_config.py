...
class Config(object):
    ...
    SUDO_USERS = get_user_list('elevated_users.json', )  # List of id's -  (not usernames) for users which have sudo access to the bot.
    ...
    API_OPENWEATHER = 'e8df4c24fb649a8ac7754a39419fdaed' #Get API_OPENWEATHER FROM OFFICAL SITE https://da.gd/VAW3
