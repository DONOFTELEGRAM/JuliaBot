...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if user.id in WHITELIST_USERS:
        if warner:
            message.reply_text("Sudos warn immune.")
        else:
            message.reply_text("Sudos triggered an auto warn filter!\n I can't warn Sudos but they should avoid abusing this.")
        return
    ...
    if num_warns >= limit:
        ...
        keyboard = InlineKeyboardMarkup([{InlineKeyboardButton("Remove warn(Admin Only)",
