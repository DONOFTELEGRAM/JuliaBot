...
if ENV:
    ...
    try:
        OWNER_ID = int(os.environ.get('OWNER_ID', '')) #owner Id // if you dont know go to @MissRose_bot and do /info
    except ValueError:
    ...
    try:
        SUDO_USERS = set(int(x) for x in os.environ.get( "","").split())
    ...
    BAN_STICKER = os.environ.get('BAN_STICKER', 'CAADAgADOwADPPEcAXkko5EB3YGYAg') #maries ban sticker
