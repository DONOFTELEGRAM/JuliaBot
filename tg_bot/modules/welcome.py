    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa! My Dev just joined!")

            # Welcome Sudos
            elif new_mem.id in SUDO_USERS:
                update.effective_message.reply_text("Huh! My Sudo just joined! Stay Alert!")

            # Welcome Support
            elif new_mem.id in SUPPORT_USERS:
                update.effective_message.reply_text("Huh! My Support User just joined!")
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text("Oof! White-listed User just joined!")

            # Welcome yourself
            elif new_mem.id == bot.id:
                update.effective_message.reply_text("Heya thanks for adding me, Don't forget to make me Admin of the Group If you need any help, head to @JuliaUpdates")
